    ...
    return (
        <div style={{ padding: '20px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px',
                ...
                >
<<<<<<< HEAD
                    üéí ÏÜåÎ™®Ìíà ({(consumables?.seedBomb || 0) + (consumables?.growthPotion || 0) + Object.values(cookedItems).reduce((sum, i) => sum + i.count, 0)})
=======
                    ?éí ?åÎ™®??({(consumables?.seedBomb || 0) + (consumables?.growthPotion || 0)})
>>>>>>> d6f7c2d7903bf175162d87138c2c3f22818edad0
                </button>
            </div>
...
<<<<<<< HEAD
                                                    ...
                                                    <span style={{
                                                        ...
                                                        fontWeight: 'bold',
                                                        whiteSpace: 'nowrap'
                                                    }}>{item.name} Ï¥ù {item.count} Í∞ú</span>
=======
                                                     alignItems: 'center'
                                                }}>
...
<<<<<<< HEAD
                                                Îπà ÎïÖÏóê Îã§ ÏûêÎûÄ ÏãùÎ¨ºÏùÑ Í∞ÄÎìù Ï±ÑÏõÅÎãàÎã§
=======
