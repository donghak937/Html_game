        ...
        <div className="shop-container">
            <div className="shop-items" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                >
                    <div style={{ fontSize: '3em' }}>💎</div>
                    <div style={{ flex: 1 }}>
                        <div style={{ fontSize: '1.2em', fontWeight: 'bold' }}>레어도 증가</div>
                ...
                >
                    <div style={{ fontSize: '3em' }}>📊</div>
                    <div style={{ flex: 1 }}>
                        <div style={{ fontSize: '1.2em', fontWeight: 'bold' }}>통계 기능 해금</div>
                ...
                >
                    <div style={{ fontSize: '3em' }}>🚜</div>
                    <div style={{ flex: 1 }}>
                        <div style={{ fontSize: '1.2em', fontWeight: 'bold' }}>전체 수확 기능 해금</div>
